...
class GameTest {
  ...
  void getCardPoints_TwoCards_PointsInTwoCardsAreEqual() {
    Card firstCard = new Card("diamonds", SuitDeck.ACE);
    Card secondCard = new Card("spades", SuitDeck.ACE);
    assertEquals(Game.getCardPoints(secondCard.getValue(), false),
  ...
  void getCardPoints_TwoCards_PointsInTwoCardsAreNotEqual() {
    Card firstCard = new Card("diamonds", SuitDeck.ACE);
    Card secondCard = new Card("spades", SuitDeck.KING);
    assertNotEquals(Game.getCardPoints(secondCard.getValue(), false),
        Game.getCardPoints(firstCard.getValue(), false));
  }
}